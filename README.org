...
Attachments are stored at <<ATTACHMENT LOCATION>>.
...
Image capture and storage is handled by [[https://developer.android.com/media/camera/camerax/take-photo][~ImageCapture~]] from Jetpack's CameraX library. On save, image filepaths will be persisted in their respective ~vehicle_attachment~ or ~mileage_attachment~ tables.
